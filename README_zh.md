# Tuya IoTOS Embeded Demo WiFi & BLE Mercury-Switch

[English](./README.md) | [中文](./README_zh.md)

## 简介 

本Demo通过涂鸦智能云平台、涂鸦智能APP、IoTOS Embeded WiFi &Ble SDK实现一款水银开关，使用涂鸦WiFi/WiFi+BLE系列模组，实现远程数据监测。
...
+ 调用应用层初始化函数 mercury_switch_init()
